      ...
      properties.map do |p|
        {
          ...
          yield_1y:           p.xpath('d:BC_1YEAR').text.to_f,
          yield_2y:           p.xpath('d:BC_2YEAR').text.to_f,
          yield_3y:           p.xpath('d:BC_3YEAR').text.to_f,
          yield_5y:           p.xpath('d:BC_5YEAR').text.to_f,
          yield_7y:           p.xpath('d:BC_7YEAR').text.to_f,
          yield_10y:          p.xpath('d:BC_10YEAR').text.to_f,
          yield_20y:          p.xpath('d:BC_20YEAR').text.to_f,
          yield_30y:          p.xpath('d:BC_30YEAR').text.to_f,
        }
      end
    end
